 ...
 * ３桁数字が３個の数式
 */
public class ThreeLengthThreeDigitExpression implements Expression {
    ...
    public ThreeLengthThreeDigitExpression(DigitInteger number1, Operator operator1, DigitInteger number2, Operator operator2, DigitInteger number3) {
    ...
    public static ThreeLengthThreeDigitExpression generate() {
        ThreeLengthThreeDigitExpression 式 =
            new ThreeLengthThreeDigitExpression(
        ...
        while (式.ゼロ除算発生()) {
            式 = new ThreeLengthThreeDigitExpression(
                    ThreeDigitInteger.random(),
                    Operator.random(),
                    ThreeDigitInteger.random(),
                    Operator.random(),
