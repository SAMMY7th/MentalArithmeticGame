...
//        Expression 左辺 = new Expression(SingleDigitInteger.valueOf(1), Operator.足す, SingleDigitInteger.valueOf(2));
//        ComparisonOperator 比較演算子 = ComparisonOperator.イコール;
//        Expression 右辺 = new Expression(SingleDigitInteger.valueOf(1), Operator.引く, SingleDigitInteger.valueOf(2));
//
